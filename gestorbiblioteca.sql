...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2025 a las 00:44:40
...
(1, 'Gabriel García Márquez', 'Gabriel García Márquez (1927–2014) fue un escritor, periodista y Nobel de Literatura colombiano, reconocido por ser uno de los máximos exponentes del realismo mágico. Su obra más famosa, Cien años de soledad, lo consagró internacionalmente. Combinó lo fantástico con la vida cotidiana de América Latina, y dejó una huella profunda en la literatura mundial.', 'C:/xampp/htdocs/Imagenes/Gabriel_García_Márquez.jpg'),
...
(11, 'Mario Vargas Llosa', 'Mario Vargas Llosa (1936) es un escritor, periodista y político peruano, ganador del Premio Nobel de Literatura en 2010. Figura clave del \"Boom\" latinoamericano, es autor de obras como La ciudad y los perros y La casa verde* Su narrativa aborda temas sociales, políticos y humanos, combinando realismo, experimentación y compromiso con la libertad individual.', 'C:/xampp/htdocs/Imagenes/Mario_Vargas_Llosa.jpg'),
...
INSERT INTO `devoluciones` (`IdDevolucion`, `IdPrestamo`, `FechaDevolucion`) VALUES
(5, 5, '2025-04-27'),
(6, 2, '2025-04-27'),
(7, 4, '2025-04-27'),
(8, 6, '2025-04-28'),
...
(1, 'Sudamericana', 'Editorial Sudamericana fue fundada en 1939 en Buenos Aires, Argentina. Se destacó por publicar a grandes autores latinoamericanos, como Gabriel García Márquez y Mario Vargas Llosa, y por impulsar el \"Boom\" de la literatura hispanoamericana. Su catálogo abarca novelas, ensayos y literatura infantil, y ha tenido un gran impacto en la cultura editorial de América Latina.', 'C:/xampp/htdocs/Imagenes/Sudamericana.jpg'),
(2, 'Francisco de Robles', 'Sobre la editorial', 'C:/xampp/htdocs/Imagenes/FranciscodeRobles.jpg'),
(3, 'Planeta', 'Editorial Planeta, fundada en 1949 en Barcelona por José Manuel Lara Hernández, es una de las principales editoriales en español. Forma parte del Grupo Planeta, un conglomerado líder en el mundo editorial, cultural y de comunicación. Publica una amplia variedad de géneros y es conocida por sus premios literarios, como el Premio Planeta de Novela.', 'C:/xampp/htdocs/Imagenes/Planeta.jpg'),
...
(9, 'Fondo de Cultura Económica', 'Sobre la editorial', 'C:/xampp/htdocs/Imagenes/FondodeCulturaEconómica.jpg'),
(10, 'Seix Barral', 'Seix Barral es una prestigiosa editorial española fundada en 1911. Reconocida por su apuesta por la literatura de calidad, ha publicado a importantes autores contemporáneos en lengua española e internacional. Forma parte del grupo Planeta y se caracteriza por impulsar obras innovadoras, apoyando tanto a escritores consagrados como a nuevas voces de la literatura.', 'C:/xampp/htdocs/Imagenes/SeixBarral.jpg'),
...
(4, '978-8420424385', 'Rayuela', 4, 'C:/xampp/htdocs/Imagenes/Rayuela.jpg', 1963, 1, 1, 736, 'Horacio Oliveira, un intelectual argentino en París, busca el sentido de la vida entre discusiones filosóficas y su amor por la Maga. La novela puede leerse en orden tradicional o siguiendo el \"tablero de dirección\" del autor, saltando entre capítulos. Una obra experimental que juega con el caos, el jazz y la imposibilidad de encontrar respuestas absolutas.'),
...
(10, '978-9681682082', 'El laberinto de la soledad', 9, 'C:/xampp/htdocs/Imagenes/Ellaberintodelasoledad.jpg', 1950, 9, 16, 208, 'Este ensayo seminal analiza la identidad mexicana a través de símbolos como la fiesta, la máscara y la Chingada. Paz explora cómo la Conquista, la Revolución y el mestizaje forjaron un carácter nacional oscilante entre el hermetismo y la explosión. Una reflexión sobre la soledad del mexicano, atrapado entre tradiciones ancestrales y la modernidad.'),
...
(16, '978-8420442143', 'La fiesta del chivo', 11, 'C:/xampp/htdocs/Imagenes/Lafiestadelchivo.jpg', 2000, 12, 2, 512, 'En República Dominicana, Urania Cabral regresa para confrontar a su padre, un exministro de Trujillo. Mientras, se narra el último día del dictador (apodado \"El Chivo\") en 1961, cuando es emboscado por conspiradores. La novela alterna entre la crueldad del régimen, los traumas de Urania y la caída del tirano, mostrando el horror y sus secuelas.'),
(17, '978-8498381498', 'El principito', 13, 'C:/xampp/htdocs/Imagenes/Elprincipito.jpg', 1943, 13, 5, 96, 'Un piloto perdido en el Sahara conoce a un niño proveniente del asteroide B-612, quien le cuenta su viaje por planetas habitados por adultos absurdos (un rey sin súbditos, un farolero que enciende lámparas inútiles). Con su rosa caprichosa y el zorro que le enseña sobre el amor, el Principito revela verdades simples pero profundas sobre la amistad y la pérdida.'),
...
(20, '978-8426413271', 'El nombre de la rosa', 16, 'C:/xampp/htdocs/Imagenes/Elnombredelarosa.jpg', 1980, 15, 2, 592, 'En 1327, el fraile franciscano Guillermo de Baskerville investiga muertes sospechosas en una abadía benedictina. Con ayuda del novicio Adso, descubre que las víctimas estudiaban un libro perdido de Aristóteles sobre la comedia, oculto en una biblioteca laberíntica. Una novela erudita que mezcla teología, semiótica y misterio medieval.'),
...
(32, '978-8408043640', 'El olvido que seremos', 24, 'C:/xampp/htdocs/Imagenes/Elolvidoqueseremos.jpg', 2006, 3, 16, 288, 'Héctor Abad Gómez, un médico y activista colombiano, es asesinado por defender derechos humanos. Su hijo, el escritor Héctor Abad Faciolince, reconstruye su vida con ternura y rabia: su lucha contra la desigualdad, su amor por la poesía y cómo su muerte marcó a la familia. Un homenaje literario que es también una denuncia política.'),
...
(40, '978-8433966479', 'Los subterráneos', 29, 'C:/xampp/htdocs/Imagenes/Lossubterráneos.jpg', 1958, 8, 8, 192, 'En el San Francisco de los años 50, Leo Percepied (alter ego de Kerouac) vive un apasionado y caótico romance con Mardou Fox, una mujer afroamericana, mientras el jazz, las drogas y la filosofía existencialista envuelven su mundo. Una novela autobiográfica que captura el espíritu rebelde de la Generación Beat, escrita en el estilo fluido y frenético característico de Kerouac.'),
...
(50, '978-8432217090', 'La ridícula idea de no volver a verte', 36, 'C:/xampp/htdocs/Imagenes/Laridículaideadenovolveraverte.jpg', 2013, 10, 16, 224, 'Rosa Montero mezcla memorias personales de su duelo por la muerte de su esposo con la vida de Marie Curie, quien también perdió a su amor tempranamente. A través de diarios, fotos y reflexiones, explora cómo el dolor transforma y qué significa seguir viviendo. Un híbrido literario íntimo y universal.');
...
INSERT INTO `multas` (`IdMulta`, `IdPrestamo`, `IdSocio`, `Monto`, `Pagado`) VALUES
(7, 9, 4, 400, 0);
...
INSERT INTO `notificaciones` (`IdNotificacion`, `IdUsuario`, `Mensaje`) VALUES
(1, 1, 'Termine de configurar su cuenta agregando una foto.'),
(3, 3, 'Termine de configurar su cuenta agregando una foto.'),
(4, 4, 'Termine de configurar su cuenta agregando una foto.'),
(5, 5, 'Termine de configurar su cuenta agregando una foto.'),
(14, 14, 'Termine de configurar su cuenta agregando una foto.'),
(15, 15, 'Termine de configurar su cuenta agregando una foto.'),
(16, 16, 'Termine de configurar su cuenta agregando una foto.'),
(17, 14, 'Agregaste el libro \'Cien años de soledad\' a la base de datos.'),
(18, 14, 'Agregaste el libro \'Don Quijote de la Mancha\' a la base de datos.'),
(19, 14, 'Agregaste el libro \'La sombra del viento\' a la base de datos.'),
(20, 14, 'Agregaste el libro \'Rayuela\' a la base de datos.'),
(21, 14, 'Agregaste el libro \'Ficciones\' a la base de datos.'),
(22, 14, 'Agregaste el libro \'La casa de los espíritus\' a la base de datos.'),
(23, 14, 'Agregaste el libro \'1984\' a la base de datos.'),
(24, 14, 'Agregaste el libro \'El amor en los tiempos del cólera\' a la base de datos.'),
(25, 14, 'Agregaste el libro \'Los detectives salvajes\' a la base de datos.'),
(26, 14, 'Agregaste el libro \'El laberinto de la soledad\' a la base de datos.'),
(27, 14, 'Agregaste el libro \'Pedro Páramo\' a la base de datos.'),
(28, 15, 'Agregaste el libro \'La ciudad y los perros\' a la base de datos.'),
(29, 15, 'Agregaste el libro \'El túnel\' a la base de datos.'),
(30, 15, 'Agregaste el libro \'Crónica de una muerte anunciada\' a la base de datos.'),
(31, 15, 'Agregaste el libro \'El Aleph\' a la base de datos.'),
(32, 15, 'Agregaste el libro \'La fiesta del chivo\' a la base de datos.'),
(33, 15, 'Agregaste el libro \'El principito\' a la base de datos.'),
(34, 15, 'Agregaste el libro \'Como agua para chocolate\' a la base de datos.'),
(35, 15, 'Agregaste el libro \'Los recuerdos del porvenir\' a la base de datos.'),
(36, 15, 'Agregaste el libro \'El nombre de la rosa\' a la base de datos.'),
(37, 15, 'Agregaste el libro \'La región más transparente\' a la base de datos.'),
(38, 15, 'Agregaste el libro \'El beso de la mujer araña\' a la base de datos.'),
(39, 15, 'Agregaste el libro \'La tregua\' a la base de datos.'),
(40, 15, 'Agregaste el libro \'La muerte de Artemio Cruz\' a la base de datos.'),
(41, 15, 'Agregaste el libro \'El coronel no tiene quien le escriba\' a la base de datos.'),
(42, 15, 'Agregaste el libro \'Santa Evita\' a la base de datos.'),
(43, 15, 'Agregaste el libro \'La invención de Morel\' a la base de datos.'),
(44, 15, 'Agregaste el libro \'La familia de Pascual Duarte\' a la base de datos.'),
(45, 15, 'Agregaste el libro \'El juego del ángel\' a la base de datos.'),
(46, 15, 'Agregaste el libro \'Los pasos perdidos\' a la base de datos.'),
(47, 16, 'Agregaste el libro \'La casa verde\' a la base de datos.'),
(48, 16, 'Agregaste el libro \'El olvido que seremos\' a la base de datos.'),
(49, 16, 'Agregaste el libro \'La noche de Tlatelolco\' a la base de datos.'),
(50, 16, 'Agregaste el libro \'El obsceno pájaro de la noche\' a la base de datos.'),
(51, 16, 'Agregaste el libro \'La guerra del fin del mundo\' a la base de datos.'),
(52, 16, 'Agregaste el libro \'El libro de arena\' a la base de datos.'),
(53, 16, 'Agregaste el libro \'La resistencia\' a la base de datos.'),
(54, 16, 'Agregaste el libro \'Noticias del imperio\' a la base de datos.'),
(55, 16, 'Agregaste el libro \'Arráncame la vida\' a la base de datos.'),
(56, 16, 'Agregaste el libro \'Los subterráneos\' a la base de datos.'),
(57, 17, 'Termine de configurar su cuenta agregando una foto.'),
(58, 17, 'Agregaste el libro \'Sobre héroes y tumbas\' a la base de datos.'),
(59, 17, 'Agregaste el libro \'La piel del cielo\' a la base de datos.'),
(60, 17, 'Agregaste el libro \'El ruido de las cosas al caer\' a la base de datos.'),
(61, 17, 'Agregaste el libro \'La virgen de los sicarios\' a la base de datos.'),
(62, 17, 'Agregaste el libro \'Delirio\' a la base de datos.'),
(63, 17, 'Agregaste el libro \'La forma de las ruinas\' a la base de datos.'),
(64, 17, 'Agregaste el libro \'Temporada de huracanes\' a la base de datos.'),
(65, 17, 'Agregaste el libro \'Los ingrávidos\' a la base de datos.'),
(66, 17, 'Agregaste el libro \'Nada\' a la base de datos.'),
(67, 17, 'Agregaste el libro \'La ridícula idea de no volver a verte\' a la base de datos.'),
(68, 18, 'Termine de configurar su cuenta agregando una foto.'),
(69, 3, 'Libro \'La ridícula idea de no volver a verte\' a devolver antes del 2025-05-02'),
(70, 3, 'Libro \'Nada\' a devolver antes del 2025-05-03'),
(72, 3, 'Libro \'Los ingrávidos\' a devolver antes del 2025-05-04'),
(73, 3, 'Libro \'La ridícula idea de no volver a verte\' a devolver antes del 2025-05-05'),
(74, 3, 'Libro \'La ridícula idea de no volver a verte\' a devolver antes del 2025-05-05'),
(75, 3, 'Libro \'El coronel no tiene quien le escriba\' a devolver antes del 2025-05-05'),
(76, 3, 'Libro \'Cien años de soledad\' a devolver antes del 2025-05-05'),
(80, 4, 'Libro \'1984\' a devolver antes del 2025-04-29'),
(81, 4, 'Libro \'Crónica de una muerte anunciada\' a devolver antes del 2025-05-07'),
(82, 4, 'Se ha generado una multa a tu cuenta');
...
INSERT INTO `prestamos` (`IdPrestamo`, `IdSocio`, `IdLibro`, `FechaPrestamo`, `FechaVuelta`, `Devuelto`) VALUES
(2, 3, 49, '2025-04-26', '2025-05-03', 1),
(4, 3, 48, '2025-04-27', '2025-05-04', 1),
(5, 3, 50, '2025-04-27', '2025-05-04', 1),
(6, 3, 50, '2025-04-28', '2025-05-05', 1),
(7, 3, 25, '2025-04-28', '2025-05-05', 1),
(8, 3, 1, '2025-04-28', '2025-05-05', 0),
(9, 4, 7, '2025-04-22', '2025-04-29', 1),
(10, 4, 14, '2025-04-30', '2025-05-07', 1);
...
(15, 'Administrador Dos', 'Admin2', '1234', '2025-04-20', 'C:/xampp/htdocs/Imagenes/Admin2.jpg', 'administrador'),
...
(18, 'Cesar Oliva', 'csrlv', '652124', '2025-04-25', 'C:/xampp/htdocs/Imagenes/csrlv.jpg', 'administrador');
...
--
ALTER TABLE `devoluciones`
  MODIFY `IdDevolucion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `multas`
  MODIFY `IdMulta` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `notificaciones`
--
ALTER TABLE `notificaciones`
  MODIFY `IdNotificacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT de la tabla `prestamos`
--
ALTER TABLE `prestamos`
  MODIFY `IdPrestamo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `librosadministradores`
  ADD CONSTRAINT `librosadministradores_ibfk_1` FOREIGN KEY (`IdAdmin`) REFERENCES `usuarios` (`IdUsuario`),
  ADD CONSTRAINT `librosadministradores_ibfk_2` FOREIGN KEY (`IdLibro`) REFERENCES `libros` (`IdLibro`);
...
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `prestamos_ibfk_1` FOREIGN KEY (`IdSocio`) REFERENCES `usuarios` (`IdUsuario`),
